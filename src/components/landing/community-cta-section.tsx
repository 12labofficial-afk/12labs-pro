        ...
        <section className="relative w-full py-14 md:py-20 bg-background overflow-hidden border-y">
            ...
            <div className="container relative z-10 px-4 md:px-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4">
                    <Button asChild size="lg" className="h-14 px-8 rounded-full shadow-xl shadow-primary/20 anim-surface-lift anim-surface-press anim-surface-focus bg-blue-500 hover:bg-blue-600 text-white">
                     ...
                     {whatsappLink ? (
                        <Button asChild size="lg" className="h-14 px-8 rounded-full shadow-xl anim-surface-lift anim-surface-press anim-surface-focus bg-green-500 hover:bg-green-600 text-white border-none">
                    ...
                    <Button asChild size="lg" className="h-14 px-8 rounded-full shadow-xl anim-surface-lift anim-surface-press anim-surface-focus bg-pink-600 hover:bg-pink-700 text-white border-none">
                        <Link href="https://www.instagram.com/12labofficial" target="_blank" prefetch={false}>
                            <Instagram className="h-6 w-6 mr-2" />
                            Instagram
                        </Link>
                    </Button>
                    <Button asChild size="lg" className="h-14 px-8 rounded-full shadow-xl anim-surface-lift anim-surface-press anim-surface-focus bg-red-600 hover:bg-red-700 text-white border-none">
