...
export const tools: ToolItem[] = [
  ...
  },
  {
    ...
    iconUrl: 'https://raw.githubusercontent.com/microsoft/fluentui-emoji/main/assets/Clapper%20board/3D/clapper_board_3d.png',
    title: 'THUMB DOWNLOAD',
    desc: 'HD MaxRes YouTube thumbnail grabber',
    category: 'visual',
...
export function FeaturesSection() {
  ...
  useEffect(() => {
    try {
      ...
      const settingsRef = ref(database, 'tool_settings');
      ...
      const pricingRef = ref(database, 'pricing_config');
      const unsubscribePricing = onValue(
        pricingRef,
        (snapshot) => {
          if (snapshot.exists()) {
