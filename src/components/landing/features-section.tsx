...
export const tools: ToolItem[] = [
  ...
  },
  {
    id: 'pro-studio',
    emoji: '⭐',
    tint: 'bg-yellow-100 dark:bg-yellow-500/15',
    title: 'PRO STUDIO',
  ...
  },
  {
    id: 'youtube-seo-kit',
    emoji: '🔍',
    tint: 'bg-cyan-100 dark:bg-cyan-500/15',
    title: 'SEO KIT',
  ...
  },
  {
    ...
    emoji: '🧠',
    tint: 'bg-fuchsia-100 dark:bg-fuchsia-500/15',
    title: 'NEW AI STUDIO',
  ...
  },
  {
    ...
    emoji: '📄',
    tint: 'bg-slate-100 dark:bg-slate-500/15',
    title: 'TRANSCRIPT',
