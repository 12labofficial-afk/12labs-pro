...
export function MaintenanceGuard({ children }: { children: React.ReactNode }) {
  ...
  const [maintenance, setMaintenance] = useState<{ enabled: boolean, endTime: string, mode?: string } | null>(null);
  ...
  const TOOL_ROUTE_PREFIXES = [
    '/studio', '/pro-studio', '/new-ai-studio', '/music-studio',
    '/script-generator', '/voice-cloning', '/thumbnail-generator',
    '/text-to-video', '/sound-search', '/seo-kit', '/pdf-tools',
    '/youtube-transcript', '/youtube-thumbnail-downloader', '/clone-studio',
  ];
