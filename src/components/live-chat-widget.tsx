...
import { Loader2, Send, MessageCircle, Bot, ImagePlus, X, Clock, ShieldCheck, Maximize2 } from 'lucide-react';
...
export function LiveChatWidget() {
  ...
  useEffect(() => {
    if (user && database) {
        ...
        const unsubscribeMessages = onValue(q, (snapshot) => {
          ...
          <div className="p-4 pt-4 pb-8 border-t bg-background shadow-lg">
             ...
             <div className="flex w-full items-end space-x-2">
                ...
                <Textarea
                    ...
                    className="min-h-[48px] max-h-32 rounded-xl bg-muted/20 border-primary/5"
                    rows={1}
                />
