...
export function StoreBottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 z-50 w-full h-16 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-t">
        ...
        {(user?.isSeller || user?.role === 'admin') ? (
            <div className="flex items-center justify-center">
                <Link href="/seller/add" prefetch={false}>
                    <div className="w-10 h-10 flex items-center justify-center rounded-full border-2 border-foreground hover:bg-muted transition-colors">
