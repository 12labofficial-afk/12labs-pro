        ...
        <Card className="rounded-[2rem] border-none shadow-xl bg-card overflow-hidden">
            ...
            <CardContent className="p-3">
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <SummaryRow icon={<Sparkles className="h-3.5 w-3.5" />} label="20% OFF SN" value={(summary.discountScriptAnalysis || 0).toLocaleString()} isLoading={isLoading} colorClass="text-emerald-500" />
