    ...
    try {
      ...
      try {
        ...
        legacyProjs = snap.docs.map(d => ({ ...d.data(), id: d.id, ref: d.ref }));
            ...
            reportClientError('src/components/admin/user-project-history-dialog.tsx:49', e);}
      ...
      try {
        ...
        partitionedProjs = snap.docs.map(d => ({ ...d.data(), id: d.id, ref: d.ref }));
            ...
            reportClientError('src/components/admin/user-project-history-dialog.tsx:55', e);}
      ...
      try {
        ...
        proPartitionedProjs = snap.docs.map(d => ({ ...d.data(), id: d.id, ref: d.ref }));
            ...
            reportClientError('src/components/admin/user-project-history-dialog.tsx:61', e);}
      ...
      try {
        ...
        proRootProjs = snap.docs.map(d => ({ ...d.data(), id: d.id, ref: d.ref }));
            ...
            reportClientError('src/components/admin/user-project-history-dialog.tsx:67', e);}
      ...
      try {
        ...
        musicPartitionedProjs = snap.docs.map(d => ({ ...d.data(), id: d.id, ref: d.ref }));
            ...
            reportClientError('src/components/admin/user-project-history-dialog.tsx:73', e);}
      ...
      try {
        ...
        chatterboxPartitionedProjs = snap.docs.map(d => ({ ...d.data(), id: d.id, ref: d.ref }));
            ...
            reportClientError('src/components/admin/user-project-history-dialog.tsx:79', e);}
      ...
      try {
        ...
        thumbnailsData = snap.docs.map(d => ({ ...d.data(), id: d.id, ref: d.ref, itemType: 'thumbnail' }));
            ...
            reportClientError('src/components/admin/user-project-history-dialog.tsx:85', e);}
