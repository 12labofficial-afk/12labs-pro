...
export default function PdfOcrPage() {
    ...
    return (
        <div className="min-h-screen bg-muted/30">
            <Head>
                <title>PDF Script Studio - Extract Text from PDF with AI Vision | 12Labs</title>
                <meta name="description" content="Quickly convert script PDFs into editable text using the 12Labs PDF Script Studio. High accuracy OCR for English and Hindi text extraction." />
            </Head>
