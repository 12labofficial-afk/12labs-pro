...
export default function MusicStudioPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#121212] text-slate-900 dark:text-[#E0E0E0] pb-32 transition-colors">
            <Head><title>TwelveLabs Music Studio</title></Head>
            ...
            <div className="container mx-auto max-w-5xl py-8 px-4 space-y-10">
                ...
                <Card className={cn(
                    "rounded-[2rem] border shadow-2xl transition-all duration-300 bg-[#1e1e1e] overflow-hidden",
                    productionMode === 'vocal' 
                        ? "border-pink-500/20 shadow-pink-900/5" 
                        : "border-indigo-500/20 shadow-indigo-900/5"
                )}>
                    {/* Header */}
                    <CardHeader className="p-6 sm:p-8 border-b border-white/5 bg-white/[0.02]">
                            ...
                            <div className="flex items-center gap-3">
                                {productionMode === 'vocal' ? (
                                    <>
                                        ...
                                        <div>
                                            <CardTitle className="text-sm font-bold uppercase tracking-wider text-white">Vocal Song Creator</CardTitle>
                                            <CardDescription className="text-[10px] text-zinc-400 font-medium">Generate songs with distinct vocal lyrics, melodies, and dynamic verse-chorus structure.</CardDescription>
                                        </div>
                                    </>
                                ) : (
                                    <>
                                        ...
                                        <div>
                                            <CardTitle className="text-sm font-bold uppercase tracking-wider text-white">Background Music Studio</CardTitle>
                                            <CardDescription className="text-[10px] text-zinc-400 font-medium">Generate rich instrumental tracks, soundscapes, cartoon scores, or video backdrops.</CardDescription>
                                        </div>
                                    </>
                                )}
                            </div>
                            <div className="flex items-center gap-2 bg-[#2d2d2d] px-3.5 py-1.5 rounded-xl border border-white/5 shrink-0 self-start sm:self-center">
                                <Zap className="h-3.5 w-3.5 text-amber-400" />
                                <span className="text-xs font-bold text-white font-mono">{cost.toLocaleString()} CREDITS / GENERATION</span>
                            </div>
                        </div>
                    </CardHeader>
                    ...
                    <CardContent className="p-6 sm:p-8 space-y-8">
                            ...
                            <div className="space-y-8 animate-in fade-in duration-300">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {SONG_PRESETS.map((preset) => (
                                            <button
                                                ...
                                                className="px-3 py-1.5 rounded-xl border border-white/5 bg-white/[0.03] hover:bg-pink-500/10 hover:border-pink-500/30 text-[11px] font-medium transition-all text-zinc-300 hover:text-white flex items-center gap-1.5"
                                            >
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Textarea 
                                        ...
                                        className="min-h-[110px] text-xs sm:text-sm font-medium rounded-2xl bg-white/[0.02] border-white/10 p-4 focus-visible:ring-pink-500 text-white"
                                    />
                                </div>
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-[10px] font-bold text-zinc-500 uppercase">Optional</span>
                                    </div>
                                    <Textarea 
                                        ...
                                        className="min-h-[110px] text-xs font-mono rounded-2xl bg-white/[0.02] border-white/10 p-4 focus-visible:ring-pink-500 text-white"
                                    />
                                </div>
                                                ...
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        isSelected 
                                                            ...
                                                            : "bg-[#252525] text-zinc-400 border-white/5 hover:bg-[#2d2d2d] hover:text-white"
                                                    )}
                                                >
                                                    {genre}
                                                </button>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <div className="space-y-1.5">
                                        <p className="text-[10px] font-bold uppercase text-zinc-400 px-1 flex items-center gap-1"><Languages className="h-3 w-3" /> Language</p>
                                        <Select value={songLanguage} onValueChange={setSongLanguage}>
                                            <SelectTrigger id="select-song-language" className="h-11 rounded-xl bg-white/[0.02] border-white/10 font-bold text-xs text-white">
                                                <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent className="rounded-xl bg-[#252525] border-white/10 text-white">
                                    ...
                                    <div className="space-y-1.5">
                                        <p className="text-[10px] font-bold uppercase text-zinc-400 px-1 flex items-center gap-1"><Sliders className="h-3 w-3" /> Mood & Vibe</p>
                                        <Select value={songMood} onValueChange={setSongMood}>
                                            <SelectTrigger id="select-song-mood" className="h-11 rounded-xl bg-white/[0.02] border-white/10 font-bold text-xs text-white">
                                                <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent className="rounded-xl bg-[#252525] border-white/10 text-white">
                                    ...
                                    <div className="space-y-1.5">
                                        <p className="text-[10px] font-bold uppercase text-zinc-400 px-1 flex items-center gap-1"><Clock className="h-3 w-3" /> Duration</p>
                                        <Select value={selectedDuration} onValueChange={setSelectedDuration}>
                                            <SelectTrigger id="select-song-duration" className="h-11 rounded-xl bg-white/[0.02] border-white/10 font-bold text-xs text-white">
                                                <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent className="rounded-xl bg-[#252525] border-white/10 text-white">
                                    ...
                                    <div className="space-y-1.5">
                                        <p className="text-[10px] font-bold uppercase text-zinc-400 px-1 flex items-center gap-1"><Zap className="h-3 w-3" /> Tempo</p>
                                        <Select value={tempo} onValueChange={setTempo}>
                                            <SelectTrigger id="select-song-tempo" className="h-11 rounded-xl bg-white/[0.02] border-white/10 font-bold text-xs text-white">
                                                <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent className="rounded-xl bg-[#252525] border-white/10 text-white">
                            ...
                            <div className="space-y-8 animate-in fade-in duration-300">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {BGM_PRESETS.map((preset) => (
                                            <button
                                                ...
                                                className="px-3 py-1.5 rounded-xl border border-white/5 bg-white/[0.03] hover:bg-indigo-500/10 hover:border-indigo-500/30 text-[11px] font-medium transition-all text-zinc-300 hover:text-white flex items-center gap-1.5"
                                            >
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Textarea 
                                        ...
                                        className="min-h-[110px] text-xs sm:text-sm font-medium rounded-2xl bg-white/[0.02] border-white/10 p-4 focus-visible:ring-indigo-500 text-white"
                                    />
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <p className="text-[10px] font-bold uppercase text-zinc-400 px-1 flex items-center gap-1"><Sliders className="h-3 w-3" /> Mood & Tone</p>
                                        <Select value={bgmMood} onValueChange={setBgmMood}>
                                            <SelectTrigger id="select-bgm-mood" className="h-11 rounded-xl bg-white/[0.02] border-white/10 font-bold text-xs text-white">
                                                <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent className="rounded-xl bg-[#252525] border-white/10 text-white">
                                    ...
                                    <div className="space-y-1.5">
                                        <p className="text-[10px] font-bold uppercase text-zinc-400 px-1 flex items-center gap-1"><Clock className="h-3 w-3" /> Duration</p>
                                        <Select value={selectedDuration} onValueChange={setSelectedDuration}>
                                            <SelectTrigger id="select-bgm-duration" className="h-11 rounded-xl bg-white/[0.02] border-white/10 font-bold text-xs text-white">
                                                <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent className="rounded-xl bg-[#252525] border-white/10 text-white">
                                    ...
                                    <div className="space-y-1.5">
                                        <p className="text-[10px] font-bold uppercase text-zinc-400 px-1 flex items-center gap-1"><Zap className="h-3 w-3" /> Tempo</p>
                                        <Select value={tempo} onValueChange={setTempo}>
                                            <SelectTrigger id="select-bgm-tempo" className="h-11 rounded-xl bg-white/[0.02] border-white/10 font-bold text-xs text-white">
                                                <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent className="rounded-xl bg-[#252525] border-white/10 text-white">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between text-xs px-2 font-semibold text-zinc-400">
                ...
                {(activeJobId || isSubmitting) && (
                    <Card className="rounded-3xl border-2 border-indigo-500/30 bg-gradient-to-br from-indigo-950/40 via-purple-950/20 to-slate-950/60 backdrop-blur-xl shadow-2xl p-8 text-center space-y-6 animate-in zoom-in-95 duration-500">
                        <div className="flex flex-col items-center justify-center space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <h3 className="text-lg font-black uppercase tracking-tight text-white">Composing Your Track</h3>
                            ...
                            <div className="flex items-center gap-2 text-xs font-mono text-indigo-400/80 bg-indigo-950/60 px-4 py-1.5 rounded-full border border-indigo-500/20">
                ...
                {readyProject && !activeJobId && !isSubmitting && (
                    <Card className="rounded-3xl border-2 border-green-500/40 bg-gradient-to-br from-emerald-950/30 via-slate-900 to-indigo-950/30 backdrop-blur-xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-4 duration-500">
                        <CardHeader className="bg-emerald-500/10 border-b border-emerald-500/20 p-6 sm:p-8 flex flex-row items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <CardDescription className="text-xs font-medium text-emerald-200/70">
                                            ...
                                            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 space-y-3">
                                                ...
                                                <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <Button 
                                                            variant="outline" 
                                                            className="h-9 px-4 rounded-xl text-xs font-bold uppercase tracking-wider border-white/20 hover:bg-white/10 text-white gap-2"
                                                            onClick={() => {
                ...
                <div className="space-y-6 pt-4">
                    ...
                    {isLoadingRequests ? (
                        ...
                        <div className="text-center py-16 border border-dashed border-white/10 rounded-3xl opacity-60 flex flex-col items-center justify-center space-y-3 bg-[#1a1a1a]/40">
                            <Music className="h-12 w-12 text-indigo-500 opacity-50" />
                            <h3 className="text-xs font-bold uppercase tracking-wider text-white">No Audio History Yet</h3>
