            ...
            <CardContent className="space-y-8 text-muted-foreground prose dark:prose-invert max-w-none">
                ...
                <div className="space-y-2">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li><strong>Refund Window:</strong> Users may request a full refund within 7 days of any purchase, provided that the purchased credits are completely unused and remain intact within the user's vault. Used credits cannot be refunded under any circumstances.</li>
                    </ul>
                </div>
