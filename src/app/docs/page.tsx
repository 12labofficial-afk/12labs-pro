...
const TOOLS_DIRECTORY = [
  {
    ...
    items: [
      ...
      {
        id: 'voice-india',
        title: 'Voice India Hub',
        path: '/voice-india',
        icon: Globe,
        description: 'Specialized localized voices tailored for Indian regional languages and accents.',
        keywords: 'Hindi AI voice, Tamil text to speech, Bengali AI narrator, Indian regional voiceovers, Marathi TTS generator, Telugu voiceover creator',
        features: ['Native dialect preservation', '12+ regional languages', 'Cultural accent mapping', 'Authentic vernacular pronunciation']
      }
    ]
  },
  {
...
export default function DocsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen text-foreground bg-[#1c1c1e] selection:bg-indigo-500/30">
      <Header />
      ...
      <main className="flex-1 py-12 px-4 md:px-8 max-w-7xl mx-auto space-y-16 w-full">
        ...
        <div className="p-6 md:p-10 rounded-[2rem] border border-white/5 bg-[#212121] shadow-2xl relative overflow-hidden space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-4">
            ...
            {/* STEP 1 */}
            <div className="p-6 rounded-2xl border border-white/[0.04] bg-[#2a2a2d] hover:border-indigo-500/20 transition-all space-y-3">
              ...
              <h3 className="text-sm font-black text-white uppercase tracking-wide">Prepare the Manuscript</h3>
              <p className="text-xs text-muted-foreground leading-relaxed font-medium">
                Write or paste your dramatic script using the standard <code className="text-white font-mono bg-white/5 px-1 py-0.5 rounded">Character: Spoken Text</code> syntax. Keep narration clean and descriptive to maximize accuracy.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-white/[0.04] bg-[#2a2a2d] hover:border-indigo-500/20 transition-all space-y-3">
              ...
              <h3 className="text-sm font-black text-white uppercase tracking-wide">Run Automated Parsing</h3>
              <p className="text-xs text-muted-foreground leading-relaxed font-medium">
            ...
            <div className="p-6 rounded-2xl border border-white/[0.04] bg-[#2a2a2d] hover:border-indigo-500/20 transition-all space-y-3">
              ...
              <h3 className="text-sm font-black text-white uppercase tracking-wide">Assign & Tune Voices</h3>
              <p className="text-xs text-muted-foreground leading-relaxed font-medium">
            ...
            <div className="p-6 rounded-2xl border border-white/[0.04] bg-[#2a2a2d] hover:border-indigo-500/20 transition-all space-y-3">
              ...
              <h3 className="text-sm font-black text-white uppercase tracking-wide">Synthesize & Download</h3>
              <p className="text-xs text-muted-foreground leading-relaxed font-medium">
          ...
          <div className="pt-6 border-t border-white/[0.04] grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="p-4 rounded-xl border border-white/5 bg-[#18181a] font-mono text-[11px] text-slate-300 leading-relaxed">
                <p><strong className="text-white">Narrator:</strong> High above the Himalayan ridges, the ancient monastery stood silently.</p>
                <p className="mt-1"><strong className="text-white">Kabir:</strong> Have you ever stood here before Meera?</p>
                <p className="mt-1"><strong className="text-white">Meera:</strong> Only in my wildest dreams, Kabir. It is beautiful.</p>
              </div>
            </div>

            <div className="lg:col-span-7 p-6 rounded-2xl border border-white/5 bg-[#2a2a2d] space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <Button asChild variant="outline" className="flex-1 justify-between h-11 rounded-xl font-black text-xs uppercase tracking-wider border-white/5 bg-transparent hover:bg-white/5">
        ...
        <div id="directory" className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
              ...
              <div className="relative w-full sm:w-64">
                ...
                <input
                  ...
                  className="w-full h-10 pl-9 pr-4 rounded-xl border border-white/5 bg-[#212121] text-xs text-white placeholder-muted-foreground focus:outline-none focus:ring-1 focus:ring-indigo-500/50"
                />
              </div>

              {/* SITEMAP REF BUTTON FOR SEARCH CRAWLERS */}
              <Button asChild size="sm" variant="outline" className="h-10 rounded-xl font-bold text-xs border-white/5">
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-wider transition-all duration-200 ${
                  activeCategory === cat
                    ...
                    : 'bg-[#212121] border border-white/5 text-muted-foreground hover:text-white hover:border-white/10'
                }`}
              >
                {cat}
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTools.flatMap(cat => cat.items).map((item) => {
              ...
              return (
                <Card key={item.id} className="rounded-3xl border-white/5 bg-[#212121] overflow-hidden hover:border-indigo-500/30 hover:shadow-xl hover:shadow-indigo-500/[0.02] transition-all flex flex-col justify-between group">
                  <CardHeader className="p-6 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-white/5 text-muted-foreground/80 border-white/5 text-[9px] font-bold">
                        {item.path}
                      </Badge>
                    </div>

                    <div className="space-y-1.5">
                      <CardTitle className="text-lg font-black text-white uppercase tracking-tight group-hover:text-indigo-400 transition-colors">
                        {item.title}
                      </CardTitle>
                  ...
                  <CardContent className="p-6 pt-0 space-y-4 border-t border-[#2a2a2d] mt-auto">
                    <div className="space-y-1.5 pt-4">
                      <h5 className="text-[10px] font-black uppercase tracking-wider text-white/50">Core Features</h5>
                      <div className="flex flex-wrap gap-1.5">
                        {item.features.map((feature, idx) => (
                          <Badge key={idx} variant="outline" className="bg-[#2a2a2d] border-white/5 text-[9px] font-semibold text-slate-300">
                            {feature}
                          </Badge>
                        ))}
                      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {INDUSTRIES_DIRECTORY.map((ind, idx) => {
              const Icon = ind.icon;
              return (
                <div key={idx} className="p-6 rounded-3xl border border-white/5 bg-[#212121] space-y-4 hover:border-indigo-500/20 transition-all">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 rounded-2xl bg-indigo-500/10 text-indigo-400">
                      <Icon className="h-5 w-5" />
                    </div>
                    <h3 className="text-sm font-black uppercase tracking-wider text-white">{ind.title}</h3>
                  </div>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    {ind.desc}
                  </p>
        ...
        <div className="p-6 md:p-10 rounded-[2rem] border border-white/5 bg-[#212121] space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {LANGUAGE_RESOURCES.map((lang, idx) => (
              <div key={idx} className="p-4 rounded-xl border border-white/[0.04] bg-[#2a2a2d] space-y-1.5">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black text-white">{lang.lang}</span>
                  <Badge variant="outline" className="bg-[#212121] text-[9px] border-white/5 text-indigo-400 font-bold">{lang.code}</Badge>
                </div>
                <p className="text-[10px] text-muted-foreground leading-snug">
                  <strong className="text-white/60">Profiles:</strong> {lang.accents}
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="p-6 md:p-10 rounded-[2rem] border border-white/5 bg-[#212121] space-y-8">
          <div className="flex items-center gap-2.5">
            ...
            <h2 className="text-xl font-black uppercase tracking-tight text-white">Frequently Asked Questions (FAQ)</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm leading-relaxed">
            
            <div className="space-y-1.5">
              <h4 className="font-bold text-white uppercase tracking-tight text-xs">Q: What is TwelveLabs Voice Studio?</h4>
            ...
            <div className="space-y-1.5">
              <h4 className="font-bold text-white uppercase tracking-tight text-xs">Q: How does the AI Script Analyzer work?</h4>
              <p className="text-xs text-muted-foreground font-medium leading-relaxed">
            ...
            <div className="space-y-1.5">
              <h4 className="font-bold text-white uppercase tracking-tight text-xs">Q: Do you support regional Indian accents?</h4>
              <p className="text-xs text-muted-foreground font-medium leading-relaxed">
            ...
            <div className="space-y-1.5">
              <h4 className="font-bold text-white uppercase tracking-tight text-xs">Q: Can I clone my own voice?</h4>
              <p className="text-xs text-muted-foreground font-medium leading-relaxed">
            ...
            <div className="space-y-1.5">
              <h4 className="font-bold text-white uppercase tracking-tight text-xs">Q: What audio formats are provided?</h4>
              <p className="text-xs text-muted-foreground font-medium leading-relaxed">
            ...
            <div className="space-y-1.5">
              <h4 className="font-bold text-white uppercase tracking-tight text-xs">Q: Can I use the generated voiceovers commercially?</h4>
              <p className="text-xs text-muted-foreground font-medium leading-relaxed">
