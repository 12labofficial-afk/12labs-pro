...
function SoundSearchContent() {
    ...
    return (
        <div className="container mx-auto max-w-4xl py-10 space-y-8">
            <Head>
                <title>Free AI Sound Effect Search - 30,000+ Royalty Free SFX | 12Labs</title>
                <meta name="description" content="Search and download thousands of copyright-free sound effects for your YouTube videos and projects. Fast, easy, and high quality SFX library by 12Labs." />
            </Head>
            <Card>
                <CardHeader>
