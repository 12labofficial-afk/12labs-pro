...
export default function AdminPendingPage() {
    ...
    useEffect(() => {
        ...
        const unsubscribeProjects = onValue(ref(database, 'pending_projects'), (snapshot) => {
        ...
        const unsubscribePro = onValue(ref(database, 'pro_projects'), (snapshot) => {
            const data = snapshot.val();
        ...
        const unsubscribeSellers = onValue(ref(database, 'pendingSellerProfiles'), (snapshot) => {
            const data = snapshot.val();
