...
export async function getWithdrawalRequests(): Promise<{ success: boolean; data?: WithdrawalRequest[]; message: string; }> {
...
export async function processWithdrawal(input: z.infer<typeof ProcessSchema>): Promise<{ success: boolean; message: string }> {
...
export async function rejectWithdrawal(input: z.infer<typeof RejectSchema>): Promise<{ success: boolean; message: string }> {
