...
function ChatView({ session, onBack, onSessionDeleted }: { session: LiveChatSession | null, onBack: () => void, onSessionDeleted: () => void }) {
    ...
    useEffect(() => {
        ...
        if (textarea) {
            ...
            const maxHeight = 112; // max-h-28 in pixels for default text size
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            // Server Action: writes message to RTDB and dispatches real-time push notification + in-app notification
            ...
            <div className="px-6 pt-4 pb-8 border-t bg-white dark:bg-card shadow-2xl z-10">
                 ...
                 <div className="flex w-full items-end space-x-2">
                    ...
                    <Textarea
                        ...
                        disabled={isSending}
                        className="min-h-[48px] max-h-32 rounded-xl bg-muted/20 border-primary/5 focus-visible:ring-primary shadow-inner"
                        rows={1}
                    />
