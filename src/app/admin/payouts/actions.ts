...
export async function getAffiliateData(): Promise<{ success: boolean; data?: { codes: AffiliateCode[], earnings: Record<string, { totalEarnings: number, totalWithdrawn: number, transactions: AffiliateTransaction[], withdrawals: AffiliateWithdrawal[] }> } , message: string }> {
